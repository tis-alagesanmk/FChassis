   ...
   public FuncParamSettings () {
      ...
      if (grid != null)
         this.AddParameterControls (grid, [
            ...
            new ComboControlInfo ("Laser cut head type", null!),
            new ComboControlInfo ("Laser type", null!),
            new _TextControlInfo ("Delay for stop-pause", null!, "ms"),
            new _TextControlInfo ("Delay for stop-abort", null!, "ms"),
            new ComboControlInfo ("Machine origin", null!),
            new ComboControlInfo ("Jog keys", null!),
            new ComboControlInfo ("Override keys", null!),
            ...
            new ComboControlInfo ("Brush", null!),

            new GroupControlInfo ("Auto Nozzle Clean Option"),
            new ComboControlInfo ("Based on", null!),
            new ComboControlInfo ("State of program", null!),

            new GroupControlInfo ("Pallet Changer Configuration"),
            new ComboControlInfo ("Pallet", null!),
            new CheckControlInfo ("Pallet Lock", null!),
            new ComboControlInfo ("Shuttle", null!),
            new ComboControlInfo ("Up/Down motion", null!),
            new ComboControlInfo ("Pallet Door", null!),
            new ComboControlInfo ("Light Barrier", null!),
            ...
            new ComboControlInfo ("High Pressure Valve", null!),
            new ComboControlInfo ("Low Pressure Valve", null!),
