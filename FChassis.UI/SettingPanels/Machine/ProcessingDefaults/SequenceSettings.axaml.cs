...
public partial class SequenceSettings : Panel{
   ...
   private void AddControls () {
      ControlInfo[] ctrlInfos = new ControlInfo[]
      {
         ...
         new ControlInfo{type=ControlInfo.Type.Text, label="Ignore holes smaller tha this"},
         new ControlInfo{type=ControlInfo.Type.Text, label="Minimum cutting head height when traversing"},
         new ControlInfo{type=ControlInfo.Type.Check, label="Route traverse lines around holes"},
         new ControlInfo{type=ControlInfo.Type.Text, label="Allowance when routing around holes"},
         new ControlInfo{type=ControlInfo.Type.Text, label="lift nozzle if routing penalty more than"},
         new ControlInfo{type=ControlInfo.Type.Text, label="Allowance when routing around tilting holes"},
         new ControlInfo{type=ControlInfo.Type.Text, label="Max.head down traverse distance"},
