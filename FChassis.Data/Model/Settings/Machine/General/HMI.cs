...
public partial class HMI : ObservableObject {
   [ObservableProperty, Prop ("General", Prop.Type.Combo, "Orientation"), PropInfo (["Portrait", "Landscape"])]
   ...
   [ObservableProperty, Prop (Prop.Type.Combo, "PLC messages to display"), PropInfo (["Only error", "Warn & error", "info, warn & error"])]
   ...
   [ObservableProperty, Prop (Prop.Type.Check, "Mini player"), DBGridPropInfo ("BindName", [
                                                                               DBGridPropColInfo{Prop.Type.Text, "ColumnName", "BindName"}])]
   //bool? miniPlayer = true;

   //[ObservableProperty, Prop (Prop.Type.Combo, "Language", null!, ["EN", "FR"])]
   //string? language = "EN";

   //[ObservableProperty, Prop (Prop.Type.Combo, "Theme", null!, ["Grey", "Blue"])]
   //string? theme = "Grey";
