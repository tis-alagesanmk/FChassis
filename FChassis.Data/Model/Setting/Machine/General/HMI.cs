...
public partial class HMI : ObservableObject {
   [ObservableProperty] private IEnumerable<string>? orientation;
   ...
   [ObservableProperty] private IEnumerable<string>? pLCMessagesToDisplay;
   [ObservableProperty] private bool? captionForcommandBarIcons = true;
   [ObservableProperty] private bool? miniPlayer = true;
   [ObservableProperty] private IEnumerable<string>? language;
   [ObservableProperty] private IEnumerable<string>? theme;
